...
export default function SimuladorPage() {
  ...
  if (questionsToShow.length === 0) {
    return (
      <div className="relative min-h-screen bg-[#f4f3ff] dark:bg-[#0a0a14]"><div className="pointer-events-none fixed left-[-80px] top-[-80px] h-[340px] w-[340px] rounded-full bg-indigo-400/20 dark:bg-indigo-500/18" style={{ filter: 'blur(90px)' }} /><div className="relative z-10"><Navigation /></div><div className="relative z-10 flex items-center justify-center pt-32"><p className="text-[13px] text-slate-400 dark:text-white/30">Cargando preguntas...</p></div></div>
    );
  }
