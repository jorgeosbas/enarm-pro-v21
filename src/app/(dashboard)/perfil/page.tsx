  ...
  return (
    <div className="relative min-h-screen bg-[#f4f3ff] dark:bg-[#0a0a14]">
      ...
      <main className="relative z-10 mx-auto max-w-2xl px-4 pb-24 pt-8 md:pb-10 lg:px-6">
        ...
        {isLoading ? (
          <div className="rounded-xl border border-indigo-200/40 bg-white/60 p-8 text-center backdrop-blur-md dark:border-white/[0.08] dark:bg-white/[0.04]">
            <p className="text-[13px] text-slate-400 dark:text-white/30">Cargando perfil...</p>
          </div>
        ) : (
          <div className="space-y-4">
                  ...
                  <div className="flex gap-4">
                    {[
                      ...
                      <label key={opt.value} className="flex cursor-pointer items-center gap-2">
                        ...
                        />
                        <span className="text-[13px] text-slate-600 dark:text-white/60">{opt.label}</span>
                      </label>
                    ))}
                  </div>
                </div>
            ...
            {/* Éxito */}
            {saved && (
              <div className="rounded-xl border border-emerald-300/40 bg-emerald-50/60 px-5 py-3 text-[13px] text-emerald-700 backdrop-blur-md dark:border-emerald-400/20 dark:bg-emerald-500/[0.07] dark:text-emerald-300">
