    ...
    <div className="relative min-h-screen bg-[#f4f3ff] dark:bg-[#0a0a14]">
      ...
      <main className="relative z-10 mx-auto max-w-lg px-4 pb-24 pt-10 md:pb-10">
        ...
        <div className="mb-6 text-center">
          <p className="text-[12px] font-medium uppercase tracking-wider text-slate-400 dark:text-white/30">{theme}</p>
        ...
        <div className="mb-6 flex flex-col items-center animate-slide-up">
          ...
          <p className="mt-1 text-[13px] text-slate-400 dark:text-white/40">{correct} de {total} correctas</p>
        </div>
        ...
        <div className="mb-5 grid grid-cols-3 gap-3">
          {[
            ...
            <div key={s.label} className="rounded-xl border border-indigo-200/40 bg-white/60 p-4 text-center backdrop-blur-md dark:border-white/[0.08] dark:bg-white/[0.04]">
              <p className="mb-1 text-[10px] uppercase tracking-wider text-slate-400 dark:text-white/30">{s.label}</p>
        ...
        {/* Tip */}
        <div className="mb-6 rounded-xl border border-amber-300/30 bg-amber-50/60 p-4 backdrop-blur-md dark:border-amber-400/20 dark:bg-amber-500/[0.07]">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          ...
          <Link
            ...
            className="flex-1 rounded-xl border border-indigo-200/40 bg-white/60 py-3 text-center text-[14px] text-slate-600 backdrop-blur-md transition-colors hover:bg-white/80 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-white/50"
          >
            Banco de preguntas
          </Link>
        </div>
