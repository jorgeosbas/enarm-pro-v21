...
export function Navigation() {
  ...
  return (
    <>
      ...
      <header
        className="sticky top-0 z-30 border-b border-indigo-200/30 bg-white/70 backdrop-blur-xl dark:border-white/[0.07] dark:bg-[#0a0a14]/80"
      >
        <nav className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3 lg:px-6">
          ...
          <Link href="/dashboard" className="flex items-center gap-1.5">
            ...
            <span className="text-[11px] font-medium text-slate-400 dark:text-white/30">Pro</span>
          </Link>
          ...
          <div className="flex items-center gap-2">
            {user && (
              <button
                ...
                className="flex items-center gap-2 rounded-lg border border-indigo-200/40 bg-white/60 px-3 py-1.5 text-[12px] text-slate-400 backdrop-blur-md transition-colors hover:bg-white/80 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-white/40 dark:hover:bg-white/[0.07]"
              ...
              >
                ...
                <kbd className="hidden rounded border border-indigo-200/40 bg-indigo-50/60 px-1 py-0.5 text-[10px] text-slate-400 dark:border-white/10 dark:bg-white/[0.06] dark:text-white/30 sm:inline">
                  ⌘K
                </kbd>
              </button>
            )}
      ...
      {/* Bottom nav mobile */}
      {!loading && user && (
        <nav className="fixed bottom-0 left-0 right-0 z-30 border-t border-indigo-200/30 bg-white/80 backdrop-blur-xl dark:border-white/[0.07] dark:bg-[#0a0a14]/90 md:hidden">
